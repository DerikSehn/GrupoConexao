export const products = [
  ...
  },
  {
    ...
    image: '/images/products/consorcios.jpg',
    title: "Consórcios",
  ...
  },
  {
    ...
    image: '/images/products/energia.jpg',
    title: "Energia Fotovoltaica com aquisição imediata sem custo algum para o contratante",
    ...
    features: [
      ...
      "Sem custo inicial para o contratante",
      "Economia na conta de energia",
      "Soluções sustentáveis e ecológicas",
      "Aumento significativo na autorização de projetos de PV solar",
      "Crescimento notável no Mercado de Usinas",
